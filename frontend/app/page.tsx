            ...
            {phase === 2 && (
              ...
              >
                <div className="relative">
                  ...
                  >
                    <p className="text-base sm:text-xl md:text-2xl tracking-wide leading-relaxed" style={{ color: "rgba(0,230,118,0.5)" }}>
                      Department of Electronics and Computer Science
                    </p>
                    <p className="text-base sm:text-xl md:text-2xl tracking-wide leading-relaxed mt-1 sm:mt-2" style={{ color: "rgba(125,255,178,0.6)" }}>
